...
const DataRow: React.FC<{
  ...
  <div
    className="flex border-b py-1.5 px-1 text-[9px]"
...
const InfoBlock: React.FC<{
  ...
  <div className="mb-2.5">
    ...
    <div
      className="text-[9px] leading-relaxed pl-2.5"
...
const TypePill: React.FC<{
  ...
  >
    ...
    <div
      className="text-[6px] uppercase opacity-50"
      style={{ color: MED_COLORS.GRAY_LIGHT }}
    >
      {sub}
    </div>
...
const Footnote: React.FC<{ text: string }> = ({ text }) => (
  <div
    className="text-[7px] mt-2 pt-1 border-t opacity-40 uppercase"
...
const AlertBox: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div
    className="border p-2 text-[9px] uppercase tracking-wider font-bold"
    style={{
...
const ClassificationStamp: React.FC<{ level: string }> = ({ level }) => (
  <div className="absolute bottom-3 left-3 pointer-events-none" style={{ zIndex: 6 }}>
    <div
      className="text-[7px] font-bold uppercase tracking-[0.2em] border px-2 py-0.5"
      style={{
        color: MED_COLORS.BLUE,
        borderColor: MED_COLORS.BLUE,
        opacity: 0.6,
  ...
  const pages: DocPage[] = [
      ...
      renderContent: () => (
        <div className="flex flex-col items-center justify-center h-full space-y-6">
          ...
          <div className="flex items-center gap-2 w-48">
            ...
            <span className="text-[7px] uppercase" style={{ color: MED_COLORS.BLUE, opacity: 0.6 }}>
              CLASSIFIED
            </span>
            <div className="flex-1 h-px" style={{ backgroundColor: MED_COLORS.BLUE, opacity: 0.3 }} />
          </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-1.5">
            {['突然发烧', '寒战', '头痛', '身体疼痛', '虚弱乏力', '呕吐恶心'].map(s => (
              <div
                key={s}
                className="text-center py-1.5 rounded border text-[9px] font-bold"
                style={{
      ...
      renderContent: () => (
        <div className="space-y-3">
          ...
          <div className="border p-2 space-y-1.5" style={{ borderColor: MED_COLORS.BLUE }}>
            <div className="text-[8px] uppercase tracking-wider mb-1.5" style={{ color: MED_COLORS.BLUE }}>
              ▸ 诊断检测流程
            </div>
    ...
    // ============================================================
    {
      ...
      renderContent: () => (
        <div className="space-y-3">
          ...
          >
            <div className="text-[9px] uppercase tracking-wider font-bold mb-1" style={{ color: MED_COLORS.BLUE }}>
              ⚠ 灭蚤灭鼠顺序 — 绝不能颠倒！
            </div>
    ...
    // ============================================================
    {
      ...
      renderContent: () => (
        <div className="space-y-3">
          <div
            className="border p-2 text-[9px] font-bold text-center"
            style={{
              borderColor: MED_COLORS.BLUE,
              color: MED_COLORS.BLUE,
              backgroundColor: `${MED_COLORS.BLUE}08`,
      ...
      renderContent: () => (
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            ...
            <div className="text-[8px] space-y-0.5" style={{ color: MED_COLORS.GRAY_LIGHT }}>
              <div>
          ...
          >
            ...
            <div className="relative w-full h-full overflow-hidden" style={{ borderRadius: '5px' }}>
              ...
              <div className="relative flex flex-col h-full" style={{ zIndex: 3, padding: '28px 32px 20px' }}>
                ...
                {page.subtitle && (
                  <div
                    className="text-[8px] uppercase tracking-[0.15em] mb-3 flex-shrink-0"
                    style={{
            ...
            {/* 键盘提示 */}
            <div
              className="absolute -bottom-10 right-0 text-[7px] uppercase tracking-wider opacity-30"
